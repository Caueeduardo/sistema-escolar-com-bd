...
class ConsultaPadraoAlteracao extends ConsultaAlteracaoPadrao{
    ...
    protected function getLinhas(){
        ...
        foreach($aListaDadosConsulta as $aDados){
            ...
            $codigoAlteracaoExclusao = $aDados["codigo"];
            $consulta .= '<td>';
            $consulta .= getAcaoExcluir('' . $this->getTabela() . '', $codigoAlteracaoExclusao);
            $consulta .= '</td>';

            $consulta .= '<td>';
            $consulta .= getAcaoAlterar('' . $this->getTabela() . '', $codigoAlteracaoExclusao);
            $consulta .= '</td>';
