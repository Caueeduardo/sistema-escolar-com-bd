...
class ConsultaAlteracaoPadrao {
    ...
    protected function getNomePastaSistema(){
    ...
    protected function getProximoCodigo($arDados, $acao){
        if($acao == "ALTERAR"){
            return $_POST["codigo"];
        }
    ...
    // AÇÕES DE FORMULARIO
    protected function excluir_registro($pagina){
    ...
    protected function incluir_registro($pagina){
        $arDados = array();
    ...
    protected function alterar_registro($pagina){
    ...
    protected function getDescricaoPorCodigo($codigo, $pagina, $nomeColuna){    
        $arDadosTurmas = array();
